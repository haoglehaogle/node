...
func NewLinuxTunnelService(tun *TunnelDevice, configScriptPath string) *TunnelService {
	return &TunnelService{tun, configScriptPath}
}

func (service *TunnelService) Start() error {
	return service.createTunDevice()
}

func (service *TunnelService) Stop() {
	var err error
	var exists bool
...
func (service *TunnelService) createTunDevice() (err error) {
...
func (service *TunnelService) deviceExists() (exists bool, err error) {
...
func (service *TunnelService) deleteDevice() {
...
func (service *TunnelService) createDeviceNode() error {
